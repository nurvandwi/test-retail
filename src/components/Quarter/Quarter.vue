            ...
            <div class>
                <div class="row pt-2 btn-quarter p-0">
                    <div class="col-3 col-md-3 stats-details">
                        ...
                        <router-link
                                v-bind:to="'/Quarter/1/' + `${$route.params.outlet_id}`"


                        >
                            <a :class=" {btnStyle: btnHover1}
                        " type="button"
                    ...
                    <div class="col-3 col-md-3 stats-details">
                        <router-link
                                v-bind:to="'/Quarter/2/' + `${$route.params.outlet_id}`"


                        >
                            <a :class=" {btnStyle: btnHover2}
                        " type="button"
                    ...
                    <div class="col-3 col-md-3 stats-details">
                        <router-link
                                v-bind:to="'/Quarter/3/' + `${$route.params.outlet_id}`"


                        >
                            <a :class=" {btnStyle: btnHover3}
                        " type="button"
                    ...
                    <div class="col-3 col-md-3 stats-details">
                        <router-link
                                v-bind:to="'/Quarter/4/' + `${$route.params.outlet_id}`"


                        >
                            <a :class=" {btnStyle: btnHover4}
                        " type="button"
