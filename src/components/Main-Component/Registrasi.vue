    ...
    <div class="col-md-12 col-12 p-0 m-0">
      ...
      <form @submit="formSubmit">
        ...
        <div class="form-row">
          ...
          <div class="form-group mb-0 col-md-6 col-6 pl-0 mb-0">
            <label
              class="custom-field one col-md-12 col-12 px-0 d-flex justify-content-center pb-0 mb-0"
            >
              <input
          ...
          <div class="form-group mb-0 col-md-6 col-6 pr-0 mb-0">
            <label
              class="custom-field one col-md-12 col-12 px-0 d-flex justify-content-center pb-0 mb-0"
            >
              <input
          ...
          <div class="form-group mb-0 col-md-12 col-12 px-0 ">
            ...
            >
              ...
              />
              <span class="placeholder">Alamat</span>
            </label>
          </div>
...
export default {
  ...
  methods: {
    ...
    formSubmit(e) {
      ...
      formData.append("nama_bank", this.data_outlet.data.nama_bank);
      ...
      if (
        ...
        if (
          this.data_outlet.data.no_ektp.length <= 16 &&
          this.data_outlet.data.no_ektp.length >= 16
        )
          if (this.file2 != null || this.data_outlet.data.file2 != null)
            if (this.file != null || this.data_outlet.data.file != null) {
              axios
                .post(
                  `https://www.inosis.co.id/mvg2020_api/api_reg.php/update-outlet-ms-demo`,
                  formData
                )
                .then(res => {
