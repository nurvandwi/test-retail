    ...
    <div class="container mt-custom mt-3">
        <div class="row text-left rows-col-3">
            ...
            >
                ...
                <div>
                    <img height="15px" src="#" alt srcset/>
                </div>
            </div>
            ...
            <div class="table-bordered col-12" style="background-color: white"
                ...
                <div class="row text-left mb-3">
                    <div class="col-6">
                        ...
                        <h5 class="font14 text-black font-weight-bolder">{{ data_user.nama_bank }}</h5>
                    </div>
                    <div class="col-6">
                        <h5 class="font16 font-gray font-custom font-weight-light">
                            No Rekening
                        </h5>
                        <h5 class="font14 text-black font-weight-bolder">{{ data_user.no_rek }}99876655544</h5>
                    </div>
                </div>
                <div class="row text-left mb-3">
                    <div class="col-6">
                        ...
                        <h5 class="font14 text-black font-weight-bolder"> {{ data_user.cabang_bank }}</h5>
                    </div>
                    <div class="col-6">
                        <h5 class="font16 font-gray font-custom font-weight-light">
                            Kota Bank
            ...
            <div class="table-bordered col-12" style="background-color: white" v-else>
                <div class="row text-left mt-2 mb-3">
                    <div class="col-12">
                        <h5 class="font16 font-gray font-custom font-weight-light">
                            Penerima
                ...
                <div class="row text-left  mb-3">
                    <div class="col-6">
                        ...
                        <h5 class="font14 text-black font-weight-bolder"> {{ data_user.kelurahan }}</h5>
                    </div>
                    <div class="col-6">
                        <h5 class="font16 font-gray font-custom font-weight-light">
                            Kota/Kab
