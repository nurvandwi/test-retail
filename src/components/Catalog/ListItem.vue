<template>
  <div class="col-md-12 col-12 p-0">
    ...
    <div v-if="contentFor === 'PulsaDetails'">
      <div
        class="card mt-3 shadow1 radius"
      ...
      >
        <div class="row no-gutters bg">
          <div class="col-md-3 col-4 px-2 align-self-center  ">
            <img
              src="../../assets/xl.png"
              class="w-50 m-auto d-flex"
              v-if="
                item.no_hp.slice(0, 4) === '0817' ||
                  item.no_hp.slice(0, 4) === '0818' ||
                  item.no_hp.slice(0, 4) === '0819' ||
                  item.no_hp.slice(0, 4) === '0859' ||
                  item.no_hp.slice(0, 4) === '0877' ||
                  item.no_hp.slice(0, 4) === '0878' ||
                  item.no_hp.slice(0, 4) === '0879'
              "
            />

            <img
              src="../../assets/indosat.png"
              class="w-75 m-auto d-flex"
              v-if="
                item.no_hp.slice(0, 4) === '0814' ||
                  item.no_hp.slice(0, 4) === '0815' ||
                  item.no_hp.slice(0, 4) === '0816' ||
                  item.no_hp.slice(0, 4) === '0855' ||
                  item.no_hp.slice(0, 4) === '0856' ||
                  item.no_hp.slice(0, 4) === '0857' ||
                  item.no_hp.slice(0, 4) === '0858'
              "
            />
            ...
            <img
              ...
              v-if="
                item.no_hp.slice(0, 4) === '0811' ||
                  item.no_hp.slice(0, 4) === '0812' ||
                  item.no_hp.slice(0, 4) === '0813' ||
                  item.no_hp.slice(0, 4) === '0821' ||
                  item.no_hp.slice(0, 4) === '0822' ||
                  item.no_hp.slice(0, 4) === '0823' ||
                  item.no_hp.slice(0, 4) === '0851' ||
                  item.no_hp.slice(0, 4) === '0852' ||
                  item.no_hp.slice(0, 4) === '0853'
              "
            />
            ...
            <img
              ...
              class="w-75 m-auto d-flex"
              v-if="
                item.no_hp.slice(0, 4) === '0831' ||
                  item.no_hp.slice(0, 4) === '0832' ||
                  item.no_hp.slice(0, 4) === '0838'
              "
            />
            ...
            <img
              ...
              class="w-100 m-auto d-flex"
              v-if="
                item.no_hp.slice(0, 4) === '0881' ||
                  item.no_hp.slice(0, 4) === '0882' ||
                  item.no_hp.slice(0, 4) === '0883' ||
                  item.no_hp.slice(0, 4) === '0884' ||
                  item.no_hp.slice(0, 4) === '0885' ||
                  item.no_hp.slice(0, 4) === '0886' ||
                  item.no_hp.slice(0, 4) === '0887' ||
                  item.no_hp.slice(0, 4) === '0888' ||
                  item.no_hp.slice(0, 4) === '0889'
              "
            />
            ...
            <img
              ...
              class="w-50 m-auto d-flex"
              v-if="
                item.no_hp.slice(0, 4) === '0895' ||
                  item.no_hp.slice(0, 4) === '0896' ||
                  item.no_hp.slice(0, 4) === '0897' ||
                  item.no_hp.slice(0, 4) === '0898' ||
                  item.no_hp.slice(0, 4) === '0899'
              "
            />
          </div>
        ...
        <div class="row no-gutters bg">
          ...
          <div class="col-md-8 col-6 ">
            <div class="card-body padding-card px-1">
              ...
              <h5 class="card-text font14px">
                {{ rebate.quantity }} x Rp. {{ rebate.rebate.rebate_value }}
              </h5>
            </div>
          </div>
          <div class="col-md-2  col-2 align-self-center pl-5">
